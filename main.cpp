...
int main()
{
    ...
    fontContainer.addFont(GameFontStrings::NEXT_SHAPE_LABEL, FONT_NEXT_SHAPE_X, FONT_NEXT_SHAPE_Y);
    fontContainer.addFont(GameFontStrings::SCORE_LABEL, FONT_SCORE_X, FONT_SCORE_Y);
    fontContainer.addFont(GameFontStrings::SCORE_INITIAL_VALUE, FONT_SCORE_VALUE_X, FONT_SCORE_VALUE_Y);
