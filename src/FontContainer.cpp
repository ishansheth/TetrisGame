...
{
    std::string fontFilePath = std::getenv("HOME") + std::string(TOSTRINGYFY(FONT_FILE_PATH));
...
void FontContainer::displaySingleString(sf::RenderWindow& displayWindow, const GameFontStrings label)
{
