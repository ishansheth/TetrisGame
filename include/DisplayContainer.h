...
static const sf::Vertex partitionLine[] =
    {
        sf::Vertex(sf::Vector2f(520.f, 1.f)),
...
static const sf::Vertex borderLine1[] =
    {
        sf::Vertex(sf::Vector2f(1.f, 1.f)),
        sf::Vertex(sf::Vector2f(799.f, 1.f))};

static const sf::Vertex borderLine2[] =
    {
        sf::Vertex(sf::Vector2f(799.f, 1.f)),
        sf::Vertex(sf::Vector2f(799.f, 599.f))};

static const sf::Vertex borderLine3[] =
    {
        sf::Vertex(sf::Vector2f(799.f, 599.f)),
        sf::Vertex(sf::Vector2f(1.f, 599.f))};

static const sf::Vertex borderLine4[] =
    {
        sf::Vertex(sf::Vector2f(1.f, 599.f)),
        sf::Vertex(sf::Vector2f(1.f, 1.f))};
...
class DisplayContainer
{
    ...
    DisplayContainer(FontContainer& fCon):
        ...
        fContainerRef(fCon)
    {
        for(int i = FIRST_ROW_Y; i < WINDOW_HEIGHT; i = i + (SQUARE_SIDE_LENGTH + 2*SQUARE_OUTLINE_THICKNESS))
        {
            individualComponentContainer[i] = std::vector<std::pair<sf::RectangleShape*,IShape*>>();
        }
    }
